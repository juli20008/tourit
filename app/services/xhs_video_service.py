...
- 不要提地址、价格、门牌号
幽默感（可选，谨慎使用）：
- 最多两句轻松评论，分散插在内容最自然能引出的位置，不要放在一起
- 风格：朋友聊天时顺口说的，生活化、自嘲、观察式；不是段子，不刻意
- 必须由 listing 实际内容触发，例如：厨房岛台很大→"以后开 party 不用把人赶进客厅了"；步入式衣柜→"终于可以把另一半的球鞋单独关一个柜子"；地下室可独立出租→"等于房子帮你还一半贷"；两个车位→"再也不用为停车位吵架了"
- 如果 listing 内容平平，找不到自然触发点，就不加，宁缺毋滥
只输出口播正文"""
...
幽默感（可选，谨慎使用）：
- 整个视频最多两句轻松评论，分散在不同楼层段，不要每段都加，不要两句放在一起
- 风格：朋友聊天时顺口说的，生活化、自嘲、观察式；不是段子，不刻意
- 必须由 listing 实际内容触发，例如：厨房岛台很大→"以后开 party 不用把人赶进客厅了"；步入式衣柜→"终于可以把另一半的球鞋单独关一个柜子"；地下室可独立出租→"等于房子帮你还一半贷"；两个车位→"再也不用为停车位吵架了"
- 如果 listing 内容平平，找不到自然触发点，就不加，宁缺毋滥
