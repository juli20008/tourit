...
- 不要提地址、价格、门牌号
幽默感（必须有，2-3处，这是硬要求）：
- 不是插段子，是顺口说出来的那种，自然分散
- 每个listing一定有值得调侃的点，找出来用：
  厨房大/岛台长：「这个岛台，同时站三个人炒菜都行，以后过节不用抢地方。」
  步入式衣柜：「这个衣柜……我就说，进去之后你会理解为什么有人为它多加一百万预算。」
  双车位：「两个车位，以后谁也不用在门口等谁挪车了，这个很重要。」
  地下室可出租：「地下室租出去，房贷少一半。剩下一半嘛……也只是少一半。」
  罕见储物/书房：「这个书房，说实话，一般这个面积的房子根本不舍得留。」
  大后院：「后院这个尺寸，夏天烧烤请二十个人没问题，前提是你有二十个朋友。」
  屋龄新/翻新：「外观看起来很普通，进门之后是另一回事。」
  反问节奏：「这个储物空间，同价位你告诉我哪套有？」
- 风格：克制、顺口、不夸张，像朋友聊天时顺便说的那句话
只输出口播正文"""
...
幽默感（必须有，整个视频2-3处，分散在不同段，这是硬要求）：
- 不是插段子，是顺口说出来的那种，像朋友聊天时带出来的那句话
- 每个listing都有值得调侃的点，找出来用：
  厨房大/岛台长：「这个岛台，同时站三个人炒菜都行，以后过节不用抢地方。」
  步入式衣柜：「这个衣柜……进去之后你会理解为什么有人为它多加一百万预算。」
  双车位：「两个车位，以后谁也不用在门口等谁挪车了，这个很重要。」
  地下室可出租：「地下室租出去，房贷少一半。剩下一半嘛……也只是少一半。」
  大后院：「后院这个尺寸，夏天烧烤请二十个人没问题，前提是你有二十个朋友。」
  屋龄新/翻新：「外观看起来很普通，进门之后是另一回事。」
  反问节奏：「这个储物空间，同价位你告诉我哪套有？」
- 克制、顺口、不夸张，自然融入，不要单独起一句"说个笑话"
