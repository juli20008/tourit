...
- 不要提地址、价格、门牌号
幽默感（可选，最多三处）：
- 不是插段子，是顺口说出来的那种，自然分散在旁白里
- 风格参考：
  反应式：「说真的，看到这个衣柜我站了好几秒没动。」
  生活类比：「地下室租出去，房贷压力少一半。剩下一半嘛……也只是少一半。」
  反差式：「外观看起来很普通，进门之后是另一回事。」
  反问式：「这个储物空间，你告诉我哪套同价位的有？」
- 必须由listing实际内容触发，找不到自然触发点就不加，宁缺毋滥
只输出口播正文"""
...
幽默感（可选，最多三处，分散在不同楼层段）：
- 不是插段子，是顺口说出来的那种评论
- 风格参考：
  反应式：「说真的，看到这个衣柜我站了好几秒没动。」
  生活类比：「地下室租出去，房贷少一半。剩下一半嘛……也只是少一半。」
  反差式：「外观看起来很普通，进门之后是另一回事。」
  反问式：「这个储物空间，同价位你告诉我哪套有？」
- 必须由listing实际内容触发，找不到自然触发点就不加，宁缺毋滥
