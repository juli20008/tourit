...
写法要求：
- 第一句：直接说出房屋基本信息，几室几卫、多少平方英尺，简洁干脆（一句话）
- 第二句开始用钩子抓人：反问、意外细节、或说出观众心里的话{cover_opener}
...
写法要求：
- 第一段第一句：直接说出房屋基本信息，几室几卫、多少平方英尺，简洁干脆（一句话）
- 第一段第二句起：用钩子抓人，反问、意外细节、或者说出观众心里的话
- 把listing描述里的具体亮点转化成生活场景——让人能脑补"住在这里是什么感觉"
- 各段情绪递进，后续段落自然过渡到各楼层，最后一段自然收尾+行动号召
- 语气像朋友私下推荐，不像经纪人在背稿
- 禁止："大家好""今天带大家""空间宽敞""采光好""布局合理""性价比高"等空洞词
- 不要提地址、价格、门牌号
