...
const DEFAULT_AREA = "/area/neLat=43.96&neLng=-79.15&swLat=43.79&swLng=-79.55&zoom=16"; // Markham / Richmond Hill only
...
const WhitelabelTitle = () => {
	...
	useEffect(() => {
		document.title = "tourit.ca — Canada Home Team";
	}, [agent]);
	return null;
};
...
<Switch>
				...
				<Route path="/for-agents" exact={true}>
					<AgentLanding />
				</Route>
