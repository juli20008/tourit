			...
			<>
				<nav className="nav">
					...
					<div className="nav-rt">
						...
						<button
							type="button"
							className="nav-desktop-only flex items-center gap-2 rounded-lg border border-[#d1d5db] bg-white px-3 py-1.5 text-xs font-semibold text-[#1e293b] shadow-sm hover:bg-[#f9fafb] transition"
